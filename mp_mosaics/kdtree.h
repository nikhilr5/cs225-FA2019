...
class KDTree
{
  ...
  private:
     ...
     */
     ...
     Point<Dim> find(vector<Point<Dim>>& newPoints, int left, int right, size_t k, int dimension);

     int findPosition(vector<Point<Dim>>& newPoints, int left, int right, size_t pivotIndex, int dimension);
